...
import type { FetchRenderWorkerConfig } from './fetch.ts';
...
export type { WebFetchMeta, FetchRenderWorkerConfig, PreparedFetchRendering, WebFetchValue } from './fetch.ts';
...
export interface Config {
    ...
    /** Limits for the private fetch rendering Worker. */
    fetchRenderWorker?: FetchRenderWorkerConfig;
}
