...
import type { PersistenceConfig, SavePackageRequest, SavedPackageReceipt, SavedPackageListing, LoadSavedRequest, LoadedPackageReceipt } from './persistence-types.ts';
...
export interface Config {
    ...
    vmTimeoutMs?: number;
    /** Optional bounded local source drafts. Omission disables disk persistence. */
...
export declare class DynamicCordisRunnerService extends TypertRemoteService {
     ...
     */
    savePackage(agent: Agent, request: SavePackageRequest): Promise<SavedPackageReceipt>;
    private assertPersistenceIdle;
    /** List committed source descriptors visible to this Session.
     * @param agent - current owner and authority scope.
     * @returns bounded source-free committed version descriptors.
     */
    listSaved(agent: Agent): Promise<SavedPackageListing[]>;
     ...
     */
    loadSaved(agent: Agent, request: LoadSavedRequest): Promise<LoadedPackageReceipt>;
    /**
