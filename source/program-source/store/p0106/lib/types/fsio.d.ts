 ...
 * stage an exclusive owner-only file in a private sibling directory and publish through the selected owner.
 ...
 * @param publish - optional protected transaction publication, retaining the held original and no-replace commit.
 */
export declare function writeFileAtomic(absolutePath: string, content: string, mode: number | undefined, signal: AbortSignal | undefined, internals?: FsIoInternals, createIfAbsent?: {
    displayPath: string;
}, publish?: (temporary: string) => Promise<void>): Promise<void>;
