...
/** Normal stop is an attempt; absence of a console does not count as successful delivery. */
export interface WindowsNormalStop {
    type: 'normal-stop';
    status: 'sent' | 'unavailable' | 'root-exited';
}
...
/**
 * Read one optional normal-stop observation without accepting malformed control output.
 * @param value - runner IPC output.
 * @returns a validated observation, or undefined for other message kinds.
 */
export declare function parseWindowsNormalStop(value: unknown): WindowsNormalStop | undefined;
/**
