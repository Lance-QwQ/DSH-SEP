 ...
 * @param diff - shared bounded preview executor and committed-mutation finalizer.
 */
export declare function applyWriteTool(ctx: Context, sandbox: FsSandboxController, diff: DiffPresentation): void;
