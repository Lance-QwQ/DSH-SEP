...
export type { RenameRetryOptions, JsonPublishFailure } from './atomic.ts';
/** Cordis plugin name. */
...
export interface Config {
    ...
    root: string;
    /** Bounded Windows EPERM/EBUSY rename recovery, without repeating business callbacks. */
    renameRetry?: Partial<RenameRetryOptions>;
}
/** Config schema. */
...
export declare class JsonStorageBackend implements StorageBackend {
    ...
    constructor(root: string, retry?: Partial<RenameRetryOptions>);
    readonly kv: KvFacet;
    private openUnit;
    close(): Promise<void>;
}
