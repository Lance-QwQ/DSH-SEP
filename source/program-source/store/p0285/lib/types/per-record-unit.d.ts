 ...
 * rollback. A failure before rename leaves the old document intact; a
 * post-rename durability failure reports storagePublish.published and must
 * be reconciled with the medium by its caller.
 *
 ...
 */
export declare function openPerRecordUnit(descriptor: KvUnitDescriptor, root: string, onClose: () => void, retry: RenameRetryOptions): Promise<KvUnit>;
/**
 ...
 * a single durable file operation. Reads/bootstrap and mutations share this
 * handle's queue; cross-process coordination remains the caller's concern.
 */
export declare class PerRecordJsonUnit implements KvUnit {
    ...
    constructor(descriptor: KvUnitDescriptor, dir: string, onClose: () => void, retry: RenameRetryOptions);
