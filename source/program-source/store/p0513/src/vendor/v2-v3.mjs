...
import { RELEASED_V2_EVENT_DISPOSITIONS, assertReleasedV2Header, releasedV2SessionFormatCodec, releasedV2SessionFormatCodec as releasedV2SessionFormatCodec$1, restoreReleasedV2Artifact } from "./v1-v2.mjs";
...
import { assertReleasedPayloadSemantics, assertReleasedSurfaceMetadata } from "./v0-v1.mjs";
...
function remapEvent(event, seq, mapping) {
	...
	if (assertLocalEvent(event)) data = remapLocalEvent(event, one, seq).data;
	switch (event.type) {
		case "command/done":
