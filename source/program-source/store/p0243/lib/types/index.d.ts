...
export interface Config {
     ...
     */
    root: string;
    /** Require the configured directory to exist and retain its physical identity throughout this backend lifetime. */
...
/** Read-only structural framing used by the boot-free metrics reader. */
export { scanZstdFrames } from './zstd.ts';
