 ...
 * @param requiredRoot - an existing root which must never be recreated.
 */
export declare function ensureDurableDirectoryWin32(target: string, requiredRoot?: string): Promise<void>;
