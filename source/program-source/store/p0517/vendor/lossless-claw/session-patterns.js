...
export function isIsolatedCronSessionKey(sessionKey) {
 ...
 */
export function sessionKeyChannelScope(sessionKey) {
    if (!sessionKey) {
        return null;
    }
...
export function isBaseChannelSessionKey(sessionKey) {
