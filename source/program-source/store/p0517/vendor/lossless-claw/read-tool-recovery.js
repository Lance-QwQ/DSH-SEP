...
export function isReadToolTruncated(text) {
...
export function resolveLiveToolResultExternalization(params) {
    const toolName = (params.callId && params.toolCallInputMap?.get(params.callId)?.name) || params.toolName;
    const content = toolName === "read"
