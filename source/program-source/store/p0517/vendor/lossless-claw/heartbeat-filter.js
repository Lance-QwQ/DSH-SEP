 ...
 */
export function isHeartbeatOkContent(content) {
 ...
 */
export function isHeartbeatNoiseContent(role, content) {
...
export function batchLooksLikeHeartbeatAckTurn(messages) {
...
export function filterSyntheticHeartbeatMessages(messages) {
...
export function turnLooksLikeHeartbeatTurn(turnMessages) {
    return turnMessages.some((message) => message.content.toLowerCase().includes(HEARTBEAT_TURN_MARKER));
}
/**
 ...
 */
export async function pruneHeartbeatOkTurns(conversationStore, conversationId, options) {
