...
export function normalizePath(dbPath) {
...
function createDatabaseSync(dbPath) {
    const supportsExtensionLoading = typeof DatabaseSync.prototype.enableLoadExtension === "function";
    return supportsExtensionLoading
        ? new DatabaseSync(dbPath, { allowExtension: true })
        : new DatabaseSync(dbPath);
}
function trackConnection(dbPath, db) {
 ...
 */
export function createLcmDatabaseConnection(dbPath) {
 ...
 */
export function closeLcmConnection(target) {
