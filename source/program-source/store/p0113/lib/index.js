...
// dsh-host-isolation/candidates/dsh-alpha2-migration-20260917/source/deepseek-harness-ddefc45fbc7f8e46dd73185e68295696d1297887/packages/jobs/jobs-local/src/index.ts
...
var LocalJobRegistry = class extends JobRegistry {
  ...
  /** An earlier provider lifetime never aliases a current process-local job. */
  ...
  start(spec) {
    ...
    const id = JobId(`${spec.kind}-${count}-${this.instanceId}`);
    let markSettled;
