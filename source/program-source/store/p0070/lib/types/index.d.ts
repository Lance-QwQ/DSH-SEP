 ...
 * binary rejection, and serialized mutations. Read windows and
...
export type { SandboxExecutionPolicy } from '@deepseek-ai/dsh-sandbox';
import type { SandboxExecutionPolicy, SandboxMode } from '@deepseek-ai/dsh-sandbox';
import type { FsDirEntry, FsEditOutcome, FsEditRequest, FsInfo, FsPathInfo, FsObservation, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome, FsMutationSummary, FsRecoveryReport } from './types.ts';
export { FsError, FsTargetKey, FsVersion, } from './types.ts';
export type { FsEditOutcome, FsEditRequest, FsDirEntry, FsErrorCode, FsInfo, FsObservation, FsPathInfo, FsTarget, FsWriteIntent, FsWriteOutcome, FsMutationSummary, FsRecoveryReport, } from './types.ts';
 ...
 * content-free, and mutations preserve guarded intent; providers document publication and recovery semantics. Optional guards add stale protection
...
export declare abstract class FileSystem extends Service {
     ...
     */
    moveFile(_source: FsTarget, _destination: FsTarget, _expected?: {
        version: FsVersion;
    }, _signal?: AbortSignal, _policy?: SandboxExecutionPolicy): Promise<FsMutationSummary>;
     ...
     * @returns durable operation metadata; unsupported providers reject explicitly.
     */
    removeFile(_target: FsTarget, _expected?: {
        version: FsVersion;
    }, _signal?: AbortSignal, _policy?: SandboxExecutionPolicy): Promise<FsMutationSummary>;
     ...
     */
    restoreMutation(_mutationId: string, _signal?: AbortSignal, _policy?: SandboxExecutionPolicy): Promise<FsMutationSummary>;
     ...
     */
    listMutations(_policy?: SandboxExecutionPolicy): Promise<FsMutationSummary[]>;
    ...
    /**
     * Create or replace UTF-8 text using the provider's publication semantics. `expected` guards intent and
     ...
     *   runs under; providers apply their documented protection.
    ...
    /**
     * Edit literal text in one provider critical section. When supplied, the version guard is checked
     ...
     *   under; providers apply their documented protection.
     *   Omit to leave the backend its own default.
