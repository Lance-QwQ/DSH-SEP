 ...
 */
export function TaskId(id: string): TaskIdentity { return id as TaskIdentity }
 ...
 */
export function TaskStepId(id: string): StepIdentity { return id as StepIdentity }
 ...
 */
export function TaskOperationId(id: string): OperationIdentity { return id as OperationIdentity }
